  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900">
              Healthcare Portal - Doctor Dashboard
            </h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Sarah Johnson</span> completed appointment at 10:30 AM
                    </p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Mike Davis</span> scheduled appointment for tomorrow
                    </p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-yellow-400 rounded-full"></div>
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Emily Chen</span> requested prescription refill
                    </p>
                  </div>
                </div>
              </div>
        ...
        {activeTab === 'patients' && (
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Patient Management</h2>
        ...
        {activeTab === 'appointments' && (
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-6">Appointment Scheduling</h2>
            <div className="bg-white rounded-lg shadow p-6">
